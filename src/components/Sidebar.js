...
const Sidebar = props => (
  <div className="fixed">
    <img src="/images/burger.svg" alt="" className="burger" />
    <img src={logo} alt="GDPR Checklist" className="logo" />
    <nav>
      <ul>
        { steps.map(s => <li><a href={`#${s.id}`}>{s.title}</a></li>)}
      </ul>
    </nav>
        ...
        <li>
          <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A//cto-security-checklist.sqreen.io/">
            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="25">
              <path fill-rule="evenodd" d="M11.63 8.095H7.67V5.5c0-.974.646-1.2 1.1-1.2h2.797V.014L7.717 0C3.443 0 2.47 3.195 2.47 5.24v2.855H0v4.414h2.47V25h5.2V12.51h3.507l.454-4.415"></path>
            </svg>
          </a>
        </li>
        <li>
